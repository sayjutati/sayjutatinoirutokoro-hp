    ...
    return (
        ...
        <video
            ...
            muted
            playsInline
            // 💡 修正ポイント: blur-3xl (64px) -> blur-2xl (40px) に変更（約2/3の強度）
            // 💡 修正ポイント: scale-[1.2] -> scale-[1.15] に微調整
            className="absolute inset-0 w-full h-full object-cover z-0 blur-xl scale-[1.15] opacity-80"
        >
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between z-10 relative">
            ...
            <motion.p 
                ...
                className="mt-6 text-xl text-slate-800 font-bold ml-[4.5rem] md:ml-[7.5rem] drop-shadow-md"
            >
                ゆるく生活をクリエイティブに。
            </motion.p>
            ...
            <motion.div 
                variants={slideInVariants}
                className="mt-12 ml-[4.5rem] md:ml-[7.5rem]"
            >
                <motion.a 
                href="#contact" 
                animate={{ 
                    y: [0, -10, 0], 
                    boxShadow: [
                    "0px 4px 10px rgba(66, 133, 244, 0.2)",       
                    "0px 15px 30px 5px rgba(66, 133, 244, 0.7)",  
                    "0px 4px 10px rgba(66, 133, 244, 0.2)"        
                    ]
                }}
