    ...
    const plans = [
        {
            ...
            description: "「SNSのリンク集だけじゃ物足りない！」って人向け。Google検索にもちゃんと載る、君だけの専用ページをジュース約1本分の値段で作るよ。",
            features: [
                "名前・自己紹介の掲載",
                "各種SNS・リンクの設置",
                "検索エンジン(SEO)対応",
        ...
        <section id="service" className="bg-slate-900 py-16 md:py-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                ...
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="max-w-4xl mx-auto mb-12 md:mb-16 bg-slate-800/80 border border-slate-700 p-4 md:p-8 rounded-2xl md:rounded-3xl backdrop-blur-sm shadow-xl"
                >
                        ...
                        <table className="w-full text-left border-collapse min-w-[500px] md:min-w-[600px]">
                            <thead>
                                <tr className="border-b-2 border-slate-700 text-xs md:text-base">
                                    <th className="p-3 md:p-4 font-normal text-slate-400 w-1/3"></th>
                                    <th className="p-3 md:p-4 font-bold text-slate-300 text-center w-1/3">一般的な制作会社 🏢</th>
                                    <th className="p-3 md:p-4 font-black text-cyan-400 text-center text-sm md:text-lg w-1/3 bg-cyan-900/20 rounded-t-xl">うち（政獣） 🐺🔥</th>
                                </tr>
                            </thead>
                            <tbody className="text-slate-300 text-xs md:text-base">
                                <tr className="border-b border-slate-700/50">
                                    <td className="p-3 md:p-4 font-medium text-slate-400">初期費用（制作費）</td>
                                    <td className="p-3 md:p-4 text-center">安くても 10万円〜</td>
                                    <td className="p-3 md:p-4 text-center text-brand-red font-black text-base md:text-xl bg-cyan-900/10">500円 〜 1万円！</td>
                                </tr>
                                <tr className="border-b border-slate-700/50">
                                    <td className="p-3 md:p-4 font-medium text-slate-400">毎月の維持費</td>
                                    <td className="p-3 md:p-4 text-center">毎月 3,000円〜</td>
                                    <td className="p-3 md:p-4 text-center font-bold text-white bg-cyan-900/10">基本 0円！</td>
                                </tr>
                                <tr className="border-b border-slate-700/50">
                                    <td className="p-3 md:p-4 font-medium text-slate-400">納期</td>
                                    <td className="p-3 md:p-4 text-center">1ヶ月〜3ヶ月</td>
                                ...
                                <tr>
                                    ...
                                    <td className="p-3 md:p-4 text-center text-[10px] md:text-sm text-slate-400">追加・変更は別料金</td>
                    ...
                    <p className="text-center text-slate-400 text-[10px] md:text-sm mt-4 md:mt-6">
                        ※複雑なシステムが必要な場合は別だけど、個人や活動者向けのサイトなら、<br className="hidden md:block" />うちの方が圧倒的にコスパ良く、おもろいものが作れるよ！
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
                    {plans.map((plan, i) => (
                        <motion.div
                            ...
                            className={`relative flex flex-col p-6 md:p-8 rounded-2xl md:rounded-3xl bg-slate-800/80 backdrop-blur-sm border ${plan.border} ${plan.popular ? 'transform md:-translate-y-4 shadow-2xl shadow-blue-900/20' : 'shadow-xl shadow-black/20'}`}
                        >
                            {/* おすすめバッジ */}
                            {plan.popular && (
                            ...
                            <button className={`w-full py-3 md:py-3 rounded-xl text-sm md:text-base text-white font-bold transition-all duration-300 shadow-md ${plan.buttonBg}`}>
                                相談してみる
                            </button>
                        </motion.div>
                    ))}
