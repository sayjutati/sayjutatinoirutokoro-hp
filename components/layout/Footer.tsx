    ...
    const snsLinks = [
        ...
        { 
        name: "ツイキャス", url: "https://twitcasting.tv/", color: "hover:bg-[#0054a6]",
        ...
        { 
        name: "YouTube", url: "https://youtube.com/", color: "hover:bg-[#FF0000]",
        ...
        { 
        name: "Spoon", url: "https://www.spooncast.net/", color: "hover:bg-[#FF7A00]",
        ...
        { 
        name: "TikTok", url: "https://tiktok.com/", color: "hover:bg-black",
